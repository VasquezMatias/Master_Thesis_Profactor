# Taken from
# https://github.com/EscVM/EscVM_YT/blob/master/Notebooks/2 - PT1.X DeepAI-Quickie/utils/preprocess.py
...
class VisionTransformer(nn.Module):
    ...
    def __init__(self, img_size=[224], patch_size=16, in_chans=3, num_classes=0, embed_dim=768, depth=12,
                 num_heads=12, mlp_ratio=4., qkv_bias=False, qk_scale=None, distilled=False, drop_rate=0., attn_drop_rate=0.,
...
class  VitGenerator(object):
    def __init__(self, name_model, patch_size, device, evaluate=True, random=False, verbose=False, num_classes=0):
    ...
    def _getModel(self):
        ...
        if self.name_model == 'vit_tiny':
                model = VisionTransformer(patch_size=self.patch_size, num_classes=self.num_classes, embed_dim=192, depth=12, num_heads=3, mlp_ratio=4,
                ...
                model = VisionTransformer(patch_size=self.patch_size, num_classes=self.num_classes, embed_dim=768, depth=12, num_heads=12, mlp_ratio=4,
                        qkv_bias=True, norm_layer=partial(nn.LayerNorm, eps=1e-6))
        else:
